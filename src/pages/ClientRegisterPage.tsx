    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl font-bold text-center">Client Registration</CardTitle>
          <CardDescription className="text-center">
            Create your client account to post projects and hire student freelancers
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <div className="text-center text-sm">
              <Link to="/register-student" className="text-muted-foreground hover:underline">
